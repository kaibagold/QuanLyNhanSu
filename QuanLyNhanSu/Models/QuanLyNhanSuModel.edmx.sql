...
-- --------------------------------------------------
-- Date Created: 09/17/2024 18:06:38
-- Generated from EDMX file: C:\Users\asus\Downloads\2024-09-17 [12.50.27]] 261.T3\MVC_Net-QuanLyNhanSuTienLuong\QuanLyNhanSu\Models\QuanLyNhanSuModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK__LuanChuyen__MaNhanVien]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[LuanChuyenNhanViens] DROP CONSTRAINT [FK__LuanChuyen__MaNhanVien];
GO
IF OBJECT_ID(N'[dbo].[FK__NhanVien__MaChuyenNganh]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NhanViens] DROP CONSTRAINT [FK__NhanVien__MaChuyenNganh];
GO
IF OBJECT_ID(N'[dbo].[FK__NhanVien__MaHopDong]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NhanViens] DROP CONSTRAINT [FK__NhanVien__MaHopDong];
GO
IF OBJECT_ID(N'[dbo].[FK__NhanVien__MaPhongBan]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NhanViens] DROP CONSTRAINT [FK__NhanVien__MaPhongBan];
GO
IF OBJECT_ID(N'[dbo].[FK__ThoiViec__MaNhanVien]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ThoiViecs] DROP CONSTRAINT [FK__ThoiViec__MaNhanVien];
GO
IF OBJECT_ID(N'[dbo].[FK__Thuong__MaNhanVien]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[KhenThuongs] DROP CONSTRAINT [FK__Thuong__MaNhanVien];
GO
IF OBJECT_ID(N'[dbo].[FK_CapNhatLuong_Luong]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CapNhatLuongs] DROP CONSTRAINT [FK_CapNhatLuong_Luong];
GO
IF OBJECT_ID(N'[dbo].[FK_CapNhatTrinhDoHocVan_NhanVien]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CapNhatTrinhDoHocVans] DROP CONSTRAINT [FK_CapNhatTrinhDoHocVan_NhanVien];
GO
IF OBJECT_ID(N'[dbo].[FK_ChiTietLuong_Luong]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ChiTietLuongs] DROP CONSTRAINT [FK_ChiTietLuong_Luong];
GO
IF OBJECT_ID(N'[dbo].[FK_KyLuat_KyLuat]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[KyLuats] DROP CONSTRAINT [FK_KyLuat_KyLuat];
GO
IF OBJECT_ID(N'[dbo].[FK_Luong_NhanVien]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Luongs] DROP CONSTRAINT [FK_Luong_NhanVien];
GO
IF OBJECT_ID(N'[dbo].[FK_NhanVien_ChucVuNhanVien]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NhanViens] DROP CONSTRAINT [FK_NhanVien_ChucVuNhanVien];
GO
IF OBJECT_ID(N'[dbo].[FK_NhanVien_TrinhDoHocVan]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NhanViens] DROP CONSTRAINT [FK_NhanVien_TrinhDoHocVan];
GO
...
IF OBJECT_ID(N'[dbo].[CapNhatLuongs]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CapNhatLuongs];
GO
IF OBJECT_ID(N'[dbo].[CapNhatTrinhDoHocVans]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CapNhatTrinhDoHocVans];
GO
IF OBJECT_ID(N'[dbo].[ChiTietLuongs]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ChiTietLuongs];
GO
IF OBJECT_ID(N'[dbo].[ChucVuNhanViens]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ChucVuNhanViens];
GO
...
GO
IF OBJECT_ID(N'[dbo].[LuanChuyenNhanViens]', 'U') IS NOT NULL
    DROP TABLE [dbo].[LuanChuyenNhanViens];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Luongs]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Luongs];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ThoiViecs]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ThoiViecs];
GO
IF OBJECT_ID(N'[dbo].[TrinhDoHocVans]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TrinhDoHocVans];
GO
